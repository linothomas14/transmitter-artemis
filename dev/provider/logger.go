...
import (
	...
	"transmitter-artemis/provider/dailylogger"
	"transmitter-artemis/util"
...
func NewLogger() *logrusLogger {
	return &logrusLogger{
		loggers: map[LogType]*logrus.Logger{
			...
			AmqLog: createLogger("amq", "amqerror"),
...
func InitLogDir() {
	...
	logDirectories := []string{
		...
		path.Join(logRootDirectory, "amq"),
		path.Join(logRootDirectory, "amqerror"),
	}
